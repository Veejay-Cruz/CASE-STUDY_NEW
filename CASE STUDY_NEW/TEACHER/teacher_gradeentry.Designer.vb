...
Partial Class teacher_gradeentry
    ...
    Private Sub InitializeComponent()
        ...
        ' DGVGradeEntry
        ' 
        DGVGradeEntry.AllowUserToAddRows = False
        ...
        ' DGVTeachingloads
        ' 
        DGVTeachingloads.AllowUserToAddRows = False
        DGVTeachingloads.AllowUserToDeleteRows = False
        ...
        sub_code.DefaultCellStyle = DataGridViewCellStyle10
